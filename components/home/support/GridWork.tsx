...
import { IconRun, IconMusic, IconHeart, IconMoodHappy, IconDeviceSpeaker } from "@tabler/icons-react";
...
export function BentoGridThirdDemo() {
    return (
        <BentoGrid className="max-w-6xl md:auto-rows-[30rem] bg-[#121212] dark mx-8 lg:mx-auto">
            {items.map((item, i) => (
                <BentoGridItem
                    key={i}
                    title={item.title}
                    ...
                    header={item.header}
                    className={cn("[&>p:text-lg] dark", item.className)}
                    icon={item.icon}
                />
            ))}
        </BentoGrid>
...
const SkeletonOne = () => {
    ...
    return (
        ...
        >
            <motion.div
                variants={variants}
                className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-white dark:bg-[#121212]"
            >
            ...
            <motion.div
                ...
                className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 w-3/4 ml-auto bg-white dark:bg-[#121212]"
            >
                <div className="w-full bg-gray-100 h-4 rounded-full dark:bg-neutral-900" />
                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
            </motion.div>
...
const SkeletonFour = () => {
    ...
    return (
        ...
        >
            <motion.div
                variants={first}
                className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-[#121212] dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
            >
                <Image
                    src="/logo.svg"
                    alt="avatar"
            ...
            <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-[#121212] dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
                <Image
                    src="/logo.svg"
                    alt="avatar"
                    height="100"
...
const items = [
    {
        title: "Personalized Music Playlists",
        description: (
            <span className="text-sm">
                AI-generated playlists tailored to your workout preferences.
            </span>
        ),
        header: <SkeletonOne />,
    ...
    {
        title: "Real-Time Music Suggestions",
        description: (
            <span className="text-sm">
                Get music suggestions based on your activity and mood.
            </span>
        ),
        header: <SkeletonTwo />,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        description: (
            <span className="text-sm">
                Choose playlists that match your mood for optimal performance.
            </span>
        ),
    ...
    {
        title: "Activity-Specific Music",
        description: (
            <span className="text-sm">
                Playlists curated for different types of fitness activities.
            </span>
        ),
        header: <SkeletonFour />,
